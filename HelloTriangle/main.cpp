...
// Used to read in SPIR-V compiled shader bytecode
...
private:
  ...
  // The Layout of the Graphics Pipeline and associated render pass
  ...
  // Command pool storing potential commands
  VkCommandPool commandPool;
  // Command buffer for each framebuffer
  std::vector<VkCommandBuffer> commandBuffers;
  // Synchronization Semaphores for pulling from the swapchain
  VkSemaphore imageAvailableSemaphore;
  VkSemaphore renderFinishedSemaphore;
  // Vertex Buffer and associated memory that we will pass to shaders
  VkBuffer vertexBuffer;
  VkDeviceMemory vertexBufferMemory;
  // Index Buffer and associated memory to resuse vertices
  VkBuffer indexBuffer;
  VkDeviceMemory indexBufferMemory;
  // Uniform Buffer Object Layout and associated memory
  VkDescriptorSetLayout descriptorSetLayout;
  VkDescriptorPool descriptorPool;
  VkDescriptorSet descriptorSet;
  VkBuffer uniformBuffer;
  VkDeviceMemory uniformBufferMemory;
  // Image and associated memory needed for textures
  ...
  /////////////////////// Command Pool and Buffers Creation /////////////////////////////////
  ...
  ///////////////////////////// Updating the Uniform Buffer Matrices /////////////////////
